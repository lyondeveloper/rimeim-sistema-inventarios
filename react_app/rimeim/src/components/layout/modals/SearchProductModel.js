...
const SearchProductModel = (props) => {
  const { onchange,
    onsearch,
    values: { termino, marca, tipo_vehiculo, ubicacion } } = props
  ...
  return (
    <div className="modal" id="modal_buscar_producto">
      <div className="modal-content">
        ...
        <div className="row">
          <TextInputField id="tipo_vehiculo"
