...
import EditClientWrapper from './topnav/EditClientWrapper';
    ...
    return (
      <header>
        ...
        <nav className='red lighten-1 top-nav'>
          <div className='small-container'>{NavWrapper && <NavWrapper />}</div>
        </nav>
              ...
              <li className={`bold ${active_quotes && 'active'}`}>
                ...
                <div className='collapsible-body'>
                  <ul>
                    ...
                    <li>
                      <Link to='/buscar_cotizacion'>Buscar</Link>
                    </li>
                  </ul>
                </div>
              </li>
              <li className={`bold ${active_devolutions && 'active'}`}>
                ...
                <div className='collapsible-body'>
                  <ul>
                    ...
                    <li>
                      <Link to='/buscar_devolucion'>Buscar</Link>
                    </li>
                  </ul>
                </div>
              </li>
              ...
              <li className={`bold ${active_products && 'active'}`}>
                ...
                <div className='collapsible-body'>
                  <ul>
                    ...
                    <li>
                      <Link to='/buscar_producto'>Buscar</Link>
                    </li>
                    <li>
