...
-- mié 06 feb 2019 21:23:31 CST
-- Model: New Model    Version: 1.0
-- Creador: Angel Hernandez
...
-- Schema db_rimeim
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `db_rimeim` ;
USE `db_rimeim` ;
...
CREATE TABLE IF NOT EXISTS `db_rimeim`.`tb_local` (
  ...
  `fecha_eliminado` DATETIME NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_local_id_usuario_creado_por_idx` (`id_usuario_creado_por` ASC) VISIBLE,
  INDEX `fk_local_id_usuario_eliminado_por_idx` (`id_usuario_eliminado_por` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `db_rimeim`.`tb_producto` (
  ...
  `fecha_eliminado` DATETIME NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `codigo_barra_UNIQUE` (`codigo_barra` ASC) VISIBLE,
  INDEX `fk_producto_id_tipo_vehiculo_idx` (`id_tipo_vehiculo` ASC) VISIBLE,
  INDEX `fk_producto_id_marca_idx` (`id_marca` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `db_rimeim`.`tb_empleado` (
  ...
  `fecha_eliminado` DATETIME NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_empleado_id_usuario_idx` (`id_usuario` ASC) VISIBLE,
  INDEX `fk_empleado_id_local_idx` (`id_local` ASC) VISIBLE,
  INDEX `fk_empleado_id_usuario_creado_por_idx` (`id_usuario_creado_por` ASC) VISIBLE,
  INDEX `fk_empleado_id_usuario_eliminado_por_idx` (`id_usuario_eliminado_por` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `db_rimeim`.`tb_cliente` (
  ...
  `fecha_eliminado` DATETIME NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `rtn_UNIQUE` (`rtn` ASC) VISIBLE,
  UNIQUE INDEX `correo_UNIQUE` (`correo` ASC) VISIBLE,
  UNIQUE INDEX `telefono_UNIQUE` (`telefono` ASC) VISIBLE,
  UNIQUE INDEX `codigo_UNIQUE` (`codigo` ASC) VISIBLE,
  INDEX `fk_cliente_id_local_registrado_idx` (`id_local_registrado` ASC) VISIBLE,
  INDEX `fk_cliente_id_empleado_creado_por_idx` (`id_empleado_creado_por` ASC) VISIBLE,
  INDEX `fk_cliente_id_usuario_eliminado_por_idx` (`id_empleado_eliminado_por` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `db_rimeim`.`tb_pedido` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `codigo_UNIQUE` (`codigo` ASC) VISIBLE,
  INDEX `fk_pedido_id_empleado_creado_por_idx` (`id_empleado_creado_por` ASC) VISIBLE,
  INDEX `fk_pedido_id_empleado_eliminado_por_idx` (`id_empleado_eliminado_por` ASC) VISIBLE,
  INDEX `fk_pedido_id_local_idx` (`id_local` ASC) VISIBLE,
  INDEX `fk_pedido_id_local_solicitado_idx` (`id_local_solicitado` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `db_rimeim`.`tb_venta` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `codigo_UNIQUE` (`codigo` ASC) VISIBLE,
  INDEX `fk_venta_id_local_idx` (`id_local` ASC) VISIBLE,
  INDEX `fk_venta_id_cliente_idx` (`id_cliente` ASC) VISIBLE,
  INDEX `fk_venta_id_empleado_creado_por_idx` (`id_empleado_creado_por` ASC) VISIBLE,
  INDEX `fk_venta_id_empleado_eliminado_por_idx` (`id_empleado_eliminado_por` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `db_rimeim`.`tb_proveedor` (
  ...
  `fecha_eliminado` DATETIME NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `tb_proveedorcol_UNIQUE` (`rtn` ASC) VISIBLE,
  UNIQUE INDEX `telefono_UNIQUE` (`telefono` ASC) VISIBLE,
  UNIQUE INDEX `correo_UNIQUE` (`correo` ASC) VISIBLE,
  INDEX `fk_proveedor_id_empleado_creado_por_idx` (`id_empleado_creado_por` ASC) VISIBLE,
  INDEX `fk_proveedor_id_imagen_idx` (`id_imagen` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `db_rimeim`.`tb_devolucion` (
  ...
  `fecha_eliminado` DATETIME NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_devolucion_id_empleado_creado_por_idx` (`id_empleado_creado_por` ASC) VISIBLE,
  INDEX `fk_devolucion_id_empleado_eliminado_por_idx` (`id_empleado_eliminado_por` ASC) VISIBLE,
  INDEX `fk_devolucion_id_venta_idx` (`id_venta` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `db_rimeim`.`tb_pedido_solicitud` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_pedido_solicitud_id_pedido_idx` (`id_pedido` ASC) VISIBLE,
  INDEX `fk_pedido_solicitud_id_local_idx` (`id_local` ASC) VISIBLE,
  INDEX `fk_pedido_solicitud_id_empleado_encargado_idx` (`id_empleado_encargado` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `db_rimeim`.`tb_producto_imagenes` (
  ...
  `fecha_eliminado` DATETIME NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_producto_imagenes_id_producto_idx` (`id_producto` ASC) VISIBLE,
  INDEX `fk_producto_imagenes_id_archivo_idx` (`id_archivo` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `db_rimeim`.`tb_producto_local` (
  ...
  `fecha_eliminado` DATETIME NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_producto_local_id_local_idx` (`id_local` ASC) VISIBLE,
  INDEX `fk_producto_local_id_producto_idx` (`id_producto` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `db_rimeim`.`tb_producto_local_ubicacion` (
  ...
  `fecha_eliminado` DATETIME NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_producto_local_ubicacion_id_producto_local_idx` (`id_producto_local` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `db_rimeim`.`tb_venta_producto` (
  ...
  `fecha_creado` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  INDEX `fk_venta_produco_id_producto_idx` (`id_producto` ASC) VISIBLE,
  INDEX `fk_venta_producto_id_venta_idx` (`id_venta` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `db_rimeim`.`tb_devolucion_producto` (
  ...
  `fecha_creado` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  INDEX `fk_devolucion_producto_id_devolucion_idx` (`id_devolucion` ASC) VISIBLE,
  INDEX `fk_devolucion_producto_id_venta_producto_idx` (`id_venta_producto` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `db_rimeim`.`tb_proveedor_producto` (
  ...
  `fecha_eliminado` DATETIME NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_proveedor_producto_id_proveedor_idx` (`id_proveedor` ASC) VISIBLE,
  INDEX `fk_proveedor_producto_id_producto_idx` (`id_producto` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `db_rimeim`.`tb_pedido_producto` (
  ...
  `fecha_eliminado` DATETIME NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_pedido_producto_id_pedido_idx` (`id_pedido` ASC) VISIBLE,
  INDEX `fk_pedido_producto_id_producto_idx` (`id_producto` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `db_rimeim`.`tb_pedido_producto_reparto` (
  ...
  `fecha_creado` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  INDEX `fk_pedido_producto_reparto_id_pedido_producto_idx` (`id_pedido_producto` ASC) VISIBLE,
  INDEX `fk_pedido_producto_reparto_id_local_idx` (`id_local` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `db_rimeim`.`tb_cliente_producto_precio` (
  ...
  `fecha_eliminado` DATETIME NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_cliente_producto_precio_id_cliente_idx` (`id_cliente` ASC) VISIBLE,
  INDEX `fk_cliente_producto_precio_id_producto_idx` (`id_producto` ASC) VISIBLE,
